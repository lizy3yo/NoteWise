          ...
          <div className="grid md:grid-cols-4 gap-12">
            <div className="col-span-1">
              ...
              <div className="flex gap-4">
                <a href="https://github.com/lizy3yo" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-teal-600 rounded-lg flex items-center justify-center hover:bg-teal-700 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    href="/features#ai-summarization"
                ...
                <li>
                  <a
                    href="/features#flashcard-generation"
                    className="text-gray-300 hover:text-teal-400 transition-colors block"
                  >
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <button
                    onClick={() => router.push("/support/study-notes")}
                    className="text-gray-300 hover:text-teal-400 transition-colors"
                  >
                    Study Notes
                  </button>
                ...
                <li>
                  <button
                    onClick={() => router.push("/support/status")}
                    className="text-gray-300 hover:text-teal-400 transition-colors"
                  >
                    Status
                  </button>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <button
                    onClick={() => router.push("/company/success-stories")}
                    className="text-gray-300 hover:text-teal-400 transition-colors"
                  >
                    Success Stories
                  </button>
