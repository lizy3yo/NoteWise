                ...
                >
                  ...
                  <div className="mt-2">
                    <button
                      ...
                      className="px-4 py-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-700 rounded-full shadow-sm text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-600 transition-colors"
                    >
                      Browse files
                    </button>
                    <input 
