...
function PrivateLibraryContent() {
  ...
  return (
    ...
    {['flashcards', 'practice_tests', 'study_guides'].map((tab) => {
            const label = tab
              .split('_')
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <span className="text-sm text-slate-500 dark:text-slate-400">
            ...
            {activeTab === 'study_guides' && '0 guides'}
          </span>
        </div>
        ...
        {activeTab === 'study_guides' && (
          <PrimaryActionButton as="button" onClick={() => alert('Coming soon!')} title="Create a study guide">
            + Create Guide
          </PrimaryActionButton>
        )}
      </div>
